    ...
    <div class="swiper-container padding-bottom-small">
      ...
      ?>
        <div class="swiper-slide padding-bottom-small grid-row justify-center align-items-stretch">
          <a class="font-size-mid font-bold font-green item-s-12 grid-row justify-center align-items-center border" href="<?php echo get_permalink( get_option( 'page_for_posts' ) ); ?>"><span>More News</span></a>
        </div>
      </div>
